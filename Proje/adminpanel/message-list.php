...
<div class="container-fluid">
    <div class="row">
        <div class="col-6">
            <h1 class="h3 mb-2 text-gray-800">Okunmuş Mesajlar</h1>
            <a href="admin-message.php" class="btn btn-primary btn-icon-split mb-3">
        ...
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>    
                            <i class="disabled fas fa-check"></i>
                    </td>
                    <td>
                        <a href="message-edit.php?id=<?php echo $message["id"] ?>" class="btn btn-info btn-circle btn-sm">
                            <i class="fas fa-edit"></i>
                        </a>
                        <a href="#" data-id="<?php echo $message["id"] ?>" class="btn btn-danger btn-circle btn-sm sil-kurs">
